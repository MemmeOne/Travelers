...
//		return result;
//	}
	public void package_save(final PackageDTO dto) {
		...
		try {
			transactionTemplate.execute(new TransactionCallbackWithoutResult() {
				...
				protected void doInTransactionWithoutResult(TransactionStatus status) {
					...
					System.out.println(dto.getTerm());
					System.out.println(dto.getStart_point());
					System.out.println(dto.getStart_date());
					System.out.println(dto.getStart_plane());
					System.out.println(dto.getEnd_point());
					System.out.println(dto.getEnd_date());
					System.out.println(dto.getEnd_plane());
					System.out.println(dto.getHotel());
					System.out.println(dto.getCity());
					System.out.println(dto.getCount());
					System.out.println(dto.getMax());
					System.out.println(dto.getCut_line());
					System.out.println(dto.getContent());
					admin_sqlSession.insert(namespace + ".package_save", dto);
				}
			});
		} catch (Exception e) {
			e.printStackTrace();
