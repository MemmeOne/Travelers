    ...
    <div class="container">
        ...
        <div id="contextMenu" class="dropdown clearfix">
            <ul class="dropdown-menu dropNewEvent" role="menu" aria-labelledby="dropdownMenu"
                ...
                <li><a   href="mate_content_view?num=22">내용</a></li>
                <li><a tabindex="-1" href="mate_content_view?num=22">내용</a></li>
        ...
        <div id="wrapper">
            <div id="loading" style="background-color:yellow">ㅁㄴㅇㄻㄴㅇㄹ</div>
            <div id="calendar" style="background-color:skyblue">ㅋㅋㅋㅋㅋㅋㅋㅋㅋ</div>
        </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row" id="hidden">
                            <div class="col-xs-12">
                                ...
                                <input class='allDayNewEvent' id="edit-allDay" type="checkbox" checked="checked"></label>
                            </div>
                        </div>
