...
<body class="is-preload">
	...
	<%@taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt"%>
					...
					<div class="checks etrans" style="width:1070px; align:center">
						<h4>< 여행 정보 ></h4>
						<div id="hidden">
...
<Td style="width:20%"><input type="button" value="검색 " onclick="search()" style="width:100%"></Td>
 ...
 <button type="button" style=" width: 1070px; " onclick="mate_content_view?num=${mate_dto.num }"  >
	여행기간 :   ${mate_dto.mtravel_date_s }<br> 
						...
						<h2 style="text-align: center;width:1070px; ">여행 동행 찾기</h2><Br>
							<table  id="box" style=" width:1070px; text-align: center;  font-size:0.9em;">
								<c:forEach items="${mate_list_all}" var="mate_dto">
