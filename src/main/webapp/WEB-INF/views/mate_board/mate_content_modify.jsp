				...
				<div class="inner">
					...
					* 모집 인원, 글 내용을 제외한 모든 조건을 입력하셔야 합니다.<br>
 					<table>
						...
						<th><input type="text" id="title" name="title" value="${ccc.title}"  autofocus="autofocus"></th>
						</tr>
						...
						<h4>< 여행 동행 조건 ></h4>
						성별 : 
						<input type="checkbox" name="mgender" value="여자" id="mgender1"  <c:out value="${ccc.mgender eq '상관없음' ? 'checked':'' }"/> onclick="oneChk_gender(this)">  <label for="mgender1">상관없음</label>
						<input type="checkbox" name="mgender" value="여자" id="mgender2" <c:out value="${ccc.mgender eq '여자' ? 'checked':'' }"/>  onclick="oneChk_gender(this)">  <label for="mgender2">여자</label>
						<input type="checkbox" name="mgender" value="남자" id="mgender3" <c:out value="${ccc.mgender eq '남자' ? 'checked':'' }"/> onclick="oneChk_gender(this)"> <label for="mgender3">남자</label>
 
						<br>
						나이 : 
						<input type="checkbox" name="mage" value="20대" id="mage1" <c:if test="${fn:contains(ccc.mage,'2') }"> checked </c:if> > <label for="mage1">20대 </label>
						<input type="checkbox" name="mage" value="30대" id="mage2" <c:if test="${fn:contains(ccc.mage,'3') }"> checked </c:if>>  <label for="mage2">30대  </label>
						<input type="checkbox" name="mage" value="40대" id="mage3" <c:if test="${fn:contains(ccc.mage,'4') }"> checked </c:if>> <label for="mage3">40대  </label>
						<input type="checkbox" name="mage" value="50대" id="mage4" <c:if test="${fn:contains(ccc.mage,'5') }"> checked </c:if>> <label for="mage4">50대  </label>
						...
						<textarea rows="15" cols="50" id="content">${ccc.content}</textarea>
						<script type="text/javascript">
							$(function() {
								//전역변수선언
							    var editor_object = [];
